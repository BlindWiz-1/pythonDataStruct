#-------------------------------------------------------------------------------
# Name:        minHeap.py
# Purpose:     Implementation of the min heap priority queue.
#
...
class minHeapPriorityQueue:
    ...
    def removeMin(self): #Removes the first node
...
for i in range (h.nrOfNodes()):
    print(h.removeMin(),end=' ')

'''
Output:

40 30 32 35 80 90 100 120
minheap: [30, 35, 32, 40, 80, 90, 100, 120]
[30, 32, 35, 40]
[120, 100, 90, 80]
30 32 35 40 80 90 100 120
